...
const ProjectCard = ({ project, onOpenModal }) => {
  ...
  return (
    <div className="rounded-[2rem] p-1.5 border border-slate-200 dark:border-white/10 bg-slate-100/50 dark:bg-white/[0.02] h-full flex flex-col transition-all duration-300 hover:border-slate-400 dark:hover:border-white/20">
      <div className="rounded-[calc(2rem-0.375rem)] p-6 sm:p-7 bg-white dark:bg-[#161b26] flex flex-col justify-between h-full border border-slate-100 dark:border-white/5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
        ...
        {/* Card Footer: Period & Case Study Button (Button-in-Button) */}
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-900/40 mb-3">
            <span>[ 03 // ARCHITECTURE & CASE STUDIES ]</span>
          </div>
        ...
        <div className="text-center mt-12">
          {!showAll && projectData.length > 3 && (
            <button
              ...
              className="inline-flex items-center gap-2.5 px-6 py-2.5 rounded-full bg-slate-900 hover:bg-slate-800 text-white dark:bg-white dark:hover:bg-slate-100 dark:text-slate-950 font-bold text-xs uppercase tracking-wider shadow-sm transition-all active:scale-98"
            >
              <span>View More Projects ({projectData.length - 3} more)</span>
          ...
          <div className="relative w-full max-w-2xl rounded-[2rem] p-1.5 border border-slate-200 dark:border-white/10 bg-white/95 dark:bg-[#161b26]/95 backdrop-blur-2xl shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
            ...
            <div className="rounded-[calc(2rem-0.375rem)] p-6 sm:p-8 bg-white dark:bg-[#161b26]">
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 dark:border-white/5 flex justify-end">
                <button
                  onClick={() => setActiveModalProject(null)}
                  className="px-5 py-2.5 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs shadow-sm transition-all"
                >
                  Close Case Study
                </button>
              </div>
